            ...
            <Dialog.Portal>
                ...
                <Dialog.Content asChild>
                    <motion.div
                        ...
                        className="fixed top-1/2 left-1/2 w-[600px] h-[480px] bg-white dark:bg-[#1e222d] border border-gray-200 dark:border-[#363a45] rounded-xl shadow-2xl z-[101] outline-none overflow-hidden flex flex-col"
                    >
                        {/* Header/Drag area */}
                        <div className="h-11 border-b border-gray-100 dark:border-[#363a45] flex items-center px-4 justify-between bg-gray-50/50 dark:bg-black/10 cursor-grab active:cursor-grabbing shrink-0">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[12px] font-black uppercase tracking-widest text-gray-900 dark:text-[#d1d4dc]">Terminal Engine Preferences</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <GripHorizontal size={14} className="text-gray-300 dark:text-gray-700 mr-2" />
                                <Dialog.Close className="p-1 hover:bg-gray-100 dark:hover:bg-[#363a45] rounded transition-all text-gray-400">
                                    <X size={18} />
                                </Dialog.Close>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-1 overflow-hidden">
                            {/* Professional Nav */}
                            <div className="w-44 border-r border-gray-100 dark:border-[#363a45] p-2 space-y-0.5 shrink-0 bg-gray-50/20 dark:bg-black/5">
                            ...
                            {/* Content Area */}
                            <div className="flex-1 p-6 overflow-y-auto custom-scrollbar bg-white dark:bg-[#1e222d]">
                                {activeTab === 'symbol' && (
                                    <div className="space-y-6 animate-in fade-in slide-in-from-right-1 duration-200">
                                        <section className="space-y-4">
                                            <div className="flex items-center gap-2">
                                                <div className="w-1 h-3 bg-blue-500 rounded-full" />
                                                <h3 className="text-[11px] font-black uppercase tracking-wider text-gray-500 dark:text-[#787b86]">Candlestick Colors</h3>
                                            </div>
                                        ...
                                        <section className="space-y-4 pt-4 border-t border-gray-100 dark:border-[#363a45]">
                                            <div className="flex items-center gap-2">
                                                <div className="w-1 h-3 bg-blue-500 rounded-full" />
                                                <h3 className="text-[11px] font-black uppercase tracking-wider text-gray-500 dark:text-[#787b86]">Detailed Elements</h3>
                                            </div>
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="space-y-1">
                                                    <span className="text-[10px] font-bold text-gray-400 uppercase ml-2 mb-1 block">Borders</span>
                                                ...
                                                <div className="space-y-1">
                                                    <span className="text-[10px] font-bold text-gray-400 uppercase ml-2 mb-1 block">Wicks</span>
                                ...
                                {activeTab === 'appearance' && (
                                    <div className="space-y-6 animate-in fade-in slide-in-from-right-1 duration-200">
                                        <section className="space-y-3">
                                            <div className="flex items-center gap-2">
                                                <div className="w-1 h-3 bg-blue-500 rounded-full" />
                                                <h3 className="text-[11px] font-black uppercase tracking-wider text-gray-500 dark:text-[#787b86]">Canvas Properties</h3>
                                            </div>
                                        ...
                                        <section className="space-y-4 pt-4 border-t border-gray-100 dark:border-[#363a45]">
                                            <div className="flex items-center gap-2">
                                                <div className="w-1 h-3 bg-blue-500 rounded-full" />
                                                <h3 className="text-[11px] font-black uppercase tracking-wider text-gray-500 dark:text-[#787b86]">Interactive Elements</h3>
                                            </div>
                                        ...
                                        <section className="space-y-4 pt-4 border-t border-gray-100 dark:border-[#363a45]">
                                            <div className="flex items-center gap-2">
                                                <div className="w-1 h-3 bg-blue-500 rounded-full" />
                                                <h3 className="text-[11px] font-black uppercase tracking-wider text-gray-500 dark:text-[#787b86]">System Grid</h3>
                                            </div>
                                        ...
                                        <section className="space-y-4 pt-4 border-t border-gray-100 dark:border-[#363a45]">
                                            <div className="flex items-center gap-2">
                                                <div className="w-1 h-3 bg-blue-500 rounded-full" />
                                                <h3 className="text-[11px] font-black uppercase tracking-wider text-gray-500 dark:text-[#787b86]">Background Watermark</h3>
                                            </div>
                                            <div className="space-y-4">
                                                ...
                                                <div className="p-3 bg-gray-50 dark:bg-black/10 rounded-lg border border-gray-100 dark:border-[#363a45]">
                                                    <div className="flex justify-between items-center mb-4">
                                                        <label className="text-[12px] font-bold text-gray-600 dark:text-[#d1d4dc]">Watermark Opacity</label>
                                                ...
                                                <div className="p-3 bg-gray-50 dark:bg-black/10 rounded-lg border border-gray-100 dark:border-[#363a45]">
                                                    <div className="flex justify-between items-center mb-4">
                                                        <label className="text-[12px] font-bold text-gray-600 dark:text-[#d1d4dc]">Scaling Ratio</label>
                                ...
                                {activeTab === 'scales' && (
                                    <div className="space-y-6 animate-in fade-in slide-in-from-right-1 duration-200">
                                        <section className="space-y-4">
                                            <div className="flex items-center gap-2">
                                                <div className="w-1 h-3 bg-blue-500 rounded-full" />
                                                <h3 className="text-[11px] font-black uppercase tracking-wider text-gray-500 dark:text-[#787b86]">Typography & Scales</h3>
                                            </div>
                                            <div className="space-y-4">
                        ...
                        <div className="h-14 border-t border-gray-100 dark:border-[#363a45] flex items-center px-4 justify-end gap-2 bg-gray-50/50 dark:bg-black/10 shrink-0">
                            <button onClick={() => onOpenChange(false)} className="px-5 py-2 text-[11px] font-black text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors uppercase tracking-widest">Discard</button>
...
const TabButton = ({ active, onClick, icon, label }: { active: boolean, onClick: () => void, icon: React.ReactNode, label: string }) => (
    <button
        ...
        className={`w-full flex items-center gap-3 px-3 py-2.5 rounded text-[12px] font-bold transition-all group ${active
            ...
            : 'text-gray-500 dark:text-[#787b86] hover:bg-gray-100 dark:hover:bg-[#363a45] hover:text-gray-900 dark:hover:text-[#d1d4dc]'
            }`}
    >
...
const ProToggle = ({ label, checked, onChange }: { label: string, checked?: boolean, onChange: (v: boolean) => void }) => (
    <label className="flex items-center justify-between p-2 hover:bg-gray-50 dark:hover:bg-black/10 rounded-lg cursor-pointer transition-colors group">
...
const ColorRow = ({ label, color, onChange }: { label: string, color: string, onChange: (c: string) => void }) => (
    <div className="flex items-center justify-between group p-1.5 hover:bg-gray-50 dark:hover:bg-black/10 rounded-lg transition-colors">
        <span className="text-[12px] font-medium text-gray-600 dark:text-[#b2b5be] group-hover:text-gray-900 dark:group-hover:text-white ml-1">{label}</span>
        <Popover.Root>
            <Popover.Trigger asChild>
                <button className="flex items-center gap-2 p-1 bg-gray-50 dark:bg-black/10 border border-gray-100 dark:border-[#363a45] hover:border-blue-500 transition-all rounded">
                    <div className="w-5 h-5 rounded-sm shadow-sm" style={{ backgroundColor: color }} />
                    <span className="text-[10px] font-mono text-gray-400 uppercase pr-1">{color}</span>
                </button>
            </Popover.Trigger>
            <Popover.Portal>
                <Popover.Content className="z-[200] animate-in fade-in zoom-in-95 duration-150" sideOffset={8} align="end">
                    <div className="bg-white dark:bg-[#1e222d] p-4 border border-gray-200 dark:border-[#363a45] rounded shadow-2xl">
                        <HexColorPicker color={color} onChange={onChange} />
                        <div className="mt-4 grid grid-cols-6 gap-2 border-t border-gray-100 dark:border-[#363a45] pt-4">
